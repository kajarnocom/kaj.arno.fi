...
Ett exempel som togs upp inom hälsovårdssektorn var en äldrevårdsrobot som ska spela musik "från ungdomen". Knappast muntrar Viljo Vesterinen och *Säkkijärven polkka* lika bra upp de ensamma på äldreboendet som Harry Brandelius och *En gång jag seglar i hamn*, men än bättre vore *Hangövalsen* av Georg Malmstén. Måtte ChatGPT lära sig sol å hav å böljedans, och allt annat som är kulturellt relevant för det svenska Finland.

Å andra sidan fanns det **föga beredskap** att vidta de åtgärder som behövs för att "feed the Dragon", för att mata AI-draken, som min meddeltagare *Matthias Railo* uttryckte det. De åtgärder som krävs är att antingen göra **omfattande mängder material om det svenska Finland** direkt och öppet tillgängligt i källform, eller att destillera och omarbeta materialet i aggregerad form på öppen data (Wikipedia, Wikidata), där det används som huvudsakligt träningsmaterial för de stora, kommersiella språkmodellerna som alla använder.
